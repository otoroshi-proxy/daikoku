...
To log in with above setup, you'll have to use one of the following users:

- admin@foo.bar / password
- dwight.schrute@dundermifflin.com / password
- jim.halpert@dundermifflin.com / password
